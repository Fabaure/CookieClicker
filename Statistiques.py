...
class Statistiques:
    ...
    def create_widgets(self):
        ...
        self.time_label = tk.Label(self.stat_frame, text=f"Temps de jeu: 00:00:00", font=("Courier", 15), fg="black", bg="white")
        self.time_label.pack(side="top", pady=20)

        # Titre des statistiques
        self.label_title = tk.Label(self.stat_frame, text="Voici les statistiques !", font=("Courier", 15), fg="black", bg="white")
        ...
        self.label_cookie_nbr = tk.Label(self.stat_frame, text="Record du nombres de cookie : " + str(self.stat_cookie), font=("Courier", 15), fg="black", bg="white")
