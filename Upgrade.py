...
class Upgrade:
    ...
    def create_widgets(self):
        ...
        self.avatar1_button = tk.Button(self.upgrade_frame, image=self.classy_button_image, bg="white",
                                        command=lambda: self.change_avatar(1), state="disabled", borderwidth=0, activebackground="white")
        ...
        self.avatar2_button = tk.Button(self.upgrade_frame, image=self.formal_button_image, bg="white",
                                        command=lambda: self.change_avatar(2), state="disabled", borderwidth=0, activebackground="white")
        ...
        self.avatar3_button = tk.Button(self.upgrade_frame, image=self.beach_button_image, bg="white",
                                        command=lambda: self.change_avatar(3), state="disabled", borderwidth=0, activebackground="white")
        ...
        self.avatar4_button = tk.Button(self.upgrade_frame, image=self.funny_button_image, bg="white",
                                        command=lambda: self.change_avatar(4), state="disabled", borderwidth=0, activebackground="white")
