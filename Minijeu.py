...
class Minijeu:
    ...
    def create_widgets(self):
        ...
        self.minijeu_button1 = tk.Button(self.minijeu_frame,
                                         text="Mini-jeu n°1\nAtteindre 500 cookies pour le débloquer", anchor="center",
                                         command=self.open_minijeu1, height=3, width=50, bg='#E2BFB3', state="disabled")
        self.minijeu_button1.pack(pady=20)

        # Bouton pour le mini-jeu n°2
        self.minijeu_button2 = tk.Button(self.minijeu_frame,
                                         text="Mini-jeu n°2\nAtteindre 10 000 cookies pour le débloquer",
        ...
        self.minijeu_button3 = tk.Button(self.minijeu_frame,
                                         text="Mini-jeu n°3\nAtteindre 50 000 cookies pour le débloquer",
