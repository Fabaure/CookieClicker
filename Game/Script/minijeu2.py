...
class Minijeu2:
    ...
    def create_widgets(self):
        ...
        self.background_image = PhotoImage(file="Assets/Images/fond2.png")
    ...
    def monstre_niveau1(self):
        ...
        self.monstre_image = PhotoImage(file="Assets/Images/monstrecontent.png").subsample(4, 4)  # Chargement de l'image du monstre et redimensionnement
    ...
    def monstre_niveau2(self):
        ...
        self.monstre_niveau2_image = PhotoImage(file="Assets/Images/monstredecu.png").subsample(2, 2)
    ...
    def monstre_niveau3(self):
        ...
        self.monstre_niveau3_image = PhotoImage(file="Assets/Images/monstreenerve.png").subsample(2, 2)
    ...
    def monstre_perdu(self):
        ...
        self.monstre_perdu_image = PhotoImage(file="Assets/Images/monstreaveccookie.png").subsample(2, 2)
