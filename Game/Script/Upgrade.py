...
class Upgrade:
    ...
    def create_widgets(self):
        self.custom_font = font.Font(family="Assets/Polices/Cookies", size=10)  # Définition d'une police personnalisée
        self.imageB = tk.PhotoImage(file="Assets/Images/BoutonUpgrade.png")
        ...
        self.title_label = tk.Label(self.upgrade_frame, text="Boutique", font=("Assets/Polices/Cookies", 60), bg='white', fg="#825D46")
        ...
        self.classy_button_image = PhotoImage(file="Assets/Images/classy_cookie.png").subsample(2,2)
        self.formal_button_image = PhotoImage(file="Assets/Images/formal_cookie.png").subsample(2,2)
        self.beach_button_image = PhotoImage(file="Assets/Images/beach_cookie.png").subsample(2,2)
        self.funny_button_image = PhotoImage(file="Assets/Images/funny_cookie.png").subsample(2,2)
        self.basic_button_image = PhotoImage(file="Assets/Images/basic_cookie.png").subsample(2,2)
    ...
    def change_avatar(self, num_avatar):
        ...
        self.classy_image = PhotoImage(file="Assets/Images/classy.png")
        self.formal_image = PhotoImage(file="Assets/Images/formal.png")
        self.beach_image = PhotoImage(file="Assets/Images/beach.png")
        self.funny_image = PhotoImage(file="Assets/Images/funny.png")
        self.cookie_image = PhotoImage(file="Assets/Images/cookie.png").zoom(2).subsample(4)
