...
class Application:
    ...
    def create_rules(self):
        ...
        rules_text = (
            ...
            "2. Augmentation de clics par seconde : Augmente de 10 le nombre de cookies reçus par clic.\n"
            "3. Roue de la fortune : Une récompense aléatoire ajoutée au compteur. Un tour gratuit dès le début de la partie ! \n\n"
            "-> Avatars <-\n"
